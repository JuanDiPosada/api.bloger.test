...
class Teacher extends Model
{
    ...
    protected $allowIncluded = ['trainingCenter', 'area', 'courses', 'trainingCenter.courses', 'area.courses', 'trainingCenter.courses.apprentice', 'area.courses.apprentice', 'courses.apprentice.computer'];

    protected $allowSort = ['name', 'email', 'area_id', 'trainingCenter_id'];
